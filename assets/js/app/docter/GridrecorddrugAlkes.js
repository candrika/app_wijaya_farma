if(!Ext.isDefined(Ext.getCmp('wItemsdrugPopupAlkes'))){
    var wItemsdrugPopupAlkes    = Ext.create(dir_sys + 'docter.wItemsdrugPopupAlkes');
}else{
    var wItemsdrugPopupAlkes    = Ext.getCmp('wItemsdrugPopupAlkes');
}


Ext.define('GridrecorddrugAlkesModel', {
...
var storeGridrecorddrugAlkes = Ext.create('Ext.data.Store', {
    pageSize: 100,
    model: 'GridrecorddrugAlkesModel',
    proxy: {
        type: 'ajax',
...
Ext.define(dir_sys + 'docter.GridrecorddrugAlkes', {
    extend: 'Ext.grid.Panel',
    id: 'GridrecorddrugAlkes',
    alias: 'widget.GridrecorddrugAlkes',
    xtype: 'cell-editing',
    initComponent: function() {
        ...
        Ext.apply(this, {
            ...
            store: storeGridrecorddrugAlkes,
            columns: [{
                    text:'Delete',
                    xtype: 'actioncolumn',
                    width: 70,
            ...
            dockedItems: [

                {
                    ...
                    items: [{
                        ...
                        scope: this,
                        handler: function(){
                            var grid = Ext.ComponentQuery.query('GridrecorddrugAlkes')[0];
