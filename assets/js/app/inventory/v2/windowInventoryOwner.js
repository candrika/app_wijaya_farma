// Ext.create(dir_sys + 'inventory.v2.GridInventoryOwnerMember');
Ext.create(dir_sys + 'inventory.v2.GridInventoryOwnerMember');
Ext.create(dir_sys + 'inventory.v2.GridInventoryOwnerNonMember');
...
Ext.define(dir_sys + 'inventory.v2.windowInventoryOwner', {
