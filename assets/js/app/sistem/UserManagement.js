...
storeGridUserManagement.on('beforeload',function(store, operation,eOpts){
       operation.params={
...
Ext.define('GridUserManagement', {
    ...
    columns: [
        ...
        { header: 'Email', dataIndex: 'email', minWidth: 250 },
        { header: 'Nama Lengkap', dataIndex: 'realname', minWidth: 150, flex:1 },
        { header: 'Koperasi', dataIndex: 'namaunit', minWidth: 200, hidden:true },
        { header: 'Kelompok User', dataIndex: 'group_name', minWidth: 150 },
        { header: 'Terakhir Login', dataIndex: 'laslogin', minWidth: 180 }
    ],
    dockedItems: [{
        xtype: 'toolbar',
        dock: 'top',
        items: [{
                ...
                handler: function() {
                    ...
                    Ext.getCmp('idUnitUser').getStore().load();
                    sys_groupStore.load();
                }
            },
            {
