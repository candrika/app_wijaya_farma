Ext.define('GridrecorddrugPaymenDetailModel', {
...
var storeGridrecorddrugPaymenDetail = Ext.create('Ext.data.Store', {
    pageSize: 100,
    model: 'GridrecorddrugPaymenDetailModel',
    proxy: {
        type: 'ajax',
...
storeGridrecorddrugPaymenDetail.on('beforeload', function(store, operation, eOpts) {
    operation.params = {
            'key':key,
...
Ext.define(dir_sys + 'sales2.GridrecorddrugPaymenDetail', {
    extend: 'Ext.grid.Panel',
    id: 'GridrecorddrugPaymenDetail',
    alias: 'widget.GridrecorddrugPaymenDetail',
    xtype: 'cell-editing',
    initComponent: function() {
        ...
        Ext.apply(this, {
            ...
            store: storeGridrecorddrugPaymenDetail,
            columns: [
            // {
            //         text:'Delete',
            //         xtype: 'actioncolumn',
            ...
            dockedItems: [
                ...
                //         scope: this,
                //         handler: function(){
                //             var grid = Ext.ComponentQuery.query('GridrecorddrugPaymenDetail')[0];
                ...
                //                                         storeGridrecorddrugPaymenDetail.load();       
                //                                     } else {
                //                                         storeGridrecorddrugPaymenDetail.load();
                //                                     }
                //                                 },
                ...
                // },
                 {
                    xtype: 'pagingtoolbar',
                    store: storeGridrecorddrugPaymenDetail, // same store GridPanel is using
                    dock: 'bottom',
                    displayInfo: true
                }
            ],
            listeners: {
                ...
                render: {
                    scope: this,
                    fn: function(grid) {
                        // disableGridrecorddrugPaymenDetail();
                    }
                }
            }
        });
